...
/*
** Structure to hold all bonus format tags
** precision defaults to -1 when not specified
*/
...
int		print_hex_layout(unsigned long nb, const char *base, const char *pre, int pre_len, t_format *f);

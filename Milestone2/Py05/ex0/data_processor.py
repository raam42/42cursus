...
#                                                +#+#+#+#+#+   +#+            #
#    Created: 2026/07/22 09:45:37 by rodrigoa         #+#    #+#              #
#    Updated: 2026/07/22 09:45:37 by rodrigoa        ###   ########.fr        #
#                                                                             #
# *************************************************************************** #
import abc
import typing
...
class DataProcessor(abc.ABC):
    """
    Abstact base class for all data stream processors.
    ...
    def validate(self, data: typing.Any) -> bool:
        """Evaluates if data type is appropiate for the processor."""
        pass

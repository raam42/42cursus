...
class DataStream:
    ...
    def display_statistics(self) -> None:
        """Prints current ingestion and storage stats for all registered processors."""
        ...
        for processor in self.processors:
            # Reformat class name (e.g., 'NumericProcessor' -> 'Numeric Processor')
...
if __name__ == "__main__":
    ...
    # The exact heterogeneous payload from the subject, including the "wil" typo
    batch = [
        'Hello world', 
        [3.14, -1, 2.71], 
